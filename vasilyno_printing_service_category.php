...
$price_list = VASILYNO_get_service_category();
...
$active_sheet->setTitle("Профессии");	
...
$active_sheet->setCellValue('A2','Управление профессиями');

$active_sheet->setCellValue('A6','№п.п');
$active_sheet->setCellValue('B6','Профессия');
...
foreach($price_list as $item) {
	...
	$active_sheet->setCellValue('B'.$row_next,$item['name_service_category']);
...
header("Content-Disposition:attachment;filename='service_category.xls'");
