...
$price_list = VASILYNO_get_masters();
...
$active_sheet->setCellValue('A2','Управление мастерами');

$active_sheet->setCellValue('A6','№п.п');
$active_sheet->setCellValue('B6','Мастер');
$active_sheet->setCellValue('C6','Направление клиентов');
$active_sheet->setCellValue('D6','Телефон');
$active_sheet->setCellValue('E6','График работы');
...
foreach($price_list as $item) {
	...
	$active_sheet->setCellValue('B'.$row_next,$item['name_master']);
	$active_sheet->setCellValue('C'.$row_next,$item['sex']);
	$active_sheet->setCellValue('D'.$row_next,$item['phone']);
	$active_sheet->setCellValue('E'.$row_next,$item['working_time']);
