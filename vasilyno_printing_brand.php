...
$active_sheet->setCellValue('A2','Управление брендами');

$active_sheet->setCellValue('A6','№п.п');
$active_sheet->setCellValue('B6','Бренд');
...
foreach($price_list as $item) {
	...
	$active_sheet->setCellValue('B'.$row_next,$item['name_brand']);
